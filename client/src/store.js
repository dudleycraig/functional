...
const useStore = create((set, get) => {
  return {
      ...
      items: [
        {
          ...
          images: {
            ...
            lg: [
              {
                status: 'no-image',
                description: 'A digital media company specialising in Clojure.',
                src: 'images/portfolio/vbt/lg.vbt-1.png',
              },
              {
                status: 'no-image',
                description: 'A digital media company specialising in Clojure.',
                src: 'images/portfolio/vbt/lg.vbt-2.png',
              },
              {
                status: 'no-image',
                description: 'A digital media company specialising in Clojure.',
                src: 'images/portfolio/vbt/lg.vbt-3.png',
              },
            ],
          },
          header: 'Very Big Things',
          brief: 'Clojure/Clojurescript development of blockchain, B2C/B2B, and WebGL applications for web and mobile.',
          technologies: ['clojure', 'clojurescript', 'reactnative', 'helix', 'keechma.next', 'tailwindcss'],
        },
        {
          name: 'opscore',
          ...
          images: {
            ...
            lg: [
              {
                status: 'no-image',
                description: 'Typescript serverless (firebase), react-native mobile/frontend management of mining industry resources.',
                src: 'images/portfolio/opscore/lg.opscore-1.png',
              },
              {
                status: 'no-image',
                description: 'Typescript serverless (firebase), react-native mobile/frontend management of mining industry resources.',
                src: 'images/portfolio/opscore/lg.opscore-2.png',
              },
              {
                status: 'no-image',
                description: 'Typescript serverless (firebase), react-native mobile/frontend management of mining industry resources.',
                src: 'images/portfolio/opscore/lg.opscore-3.png',
              },
            ],
          },
          header: 'OpsCore',
          brief: 'Typescript serverless (firebase), react-native mobile/frontend management of mining industry resources.',
          technologies: ['typescript', 'firebase', 'react', 'reactnative'],
        },
        {
          name: 'indaba',
    ...
    tech: {
      ...
      clojurescript: {
        link: '#tech-clojurescript',
        text: 'ClojureScript',
        title: 'ClojureScript',
        description: 'LISP based functional programming compiled to Javascript.',
        icon: 'ClojureScript',
        months: 48,
        proficiency: 7,
        current: true,
      ...
      integrant: {
        ...
        text: 'Integrant',
        title: 'Integrant',
        description: 'Data driven system architecture.',
        icon: 'Clojure',
        months: 24,
        proficiency: 6,
        current: true,
      ...
      helix: {
        ...
        text: 'Helix',
        title: 'Helix',
        description: 'A Cljs wrapper for React.',
        icon: 'ClojureScript',
        months: 24,
        proficiency: 7,
        current: true,
      ...
      reframe: {
        ...
        text: 'Re-Frame',
        title: 'Re-Frame',
        description: 'Clojure derivative of Redux.',
        icon: 'ClojureScript',
        months: 8,
        proficiency: 4,
        current: true,
      ...
      reitit: {
        ...
        text: 'Reitit',
        title: 'Reitit',
        description: 'Data driven routing.',
        icon: 'Clojure',
        months: 24,
        proficiency: 24,
        current: true,
      ...
      reactnative: {
        link: '#tech-reactnative',
        text: 'React Native',
        title: 'React Native',
        description: 'Cross compiler for Android and iOS written in javascript react.',
        icon: 'faReact',
        months: 24,
        proficiency: 6,
        current: true,
      ...
      lacinia: {
        ...
        text: 'Lacinia',
        title: 'Lacinia',
        description: 'GraphQL implementation for Clojure.',
        icon: 'Clojure',
        months: 4,
        proficiency: 6,
        current: true,
      ...
      tailwindcss: {
        link: '#tech-tailwindcss',
        text: 'Tailwind',
        title: 'Tailwind',
        description: 'CSS Framework for building web applications.',
        icon: 'Tailwindcss',
        months: 12,
        proficiency: 5,
        current: true,
