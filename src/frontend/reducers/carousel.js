...
const initialState = {
  ...
  items: [
    ...
    },
    {
      ...
      header: 'Cognician',
      brief:
        'White labelled, business oriented coaching. Mine was the development of client bespoke features and changes.',
    ...
    },
    {
      ...
      brief:
        "Specialized eCommerce workshop specific to Hybris and Magento. The primary projects being Click's pharmacy features.",
